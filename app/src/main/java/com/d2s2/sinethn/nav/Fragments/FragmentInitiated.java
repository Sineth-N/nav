...
public class FragmentInitiated extends Fragment {
    ...
    private AdapterInitiated adapterInitiated;
    private RecyclerView InitiatedFragRecycleView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapterInitiated = new AdapterInitiated(getActivity());
        View view = inflater.inflate(R.layout.fragment_initiated, container, false);
        InitiatedFragRecycleView = (RecyclerView) view.findViewById(R.id.recInitiated);
        InitiatedFragRecycleView.setLayoutManager(new LinearLayoutManager(getActivity()));
        InitiatedFragRecycleView.setAdapter(adapterInitiated);
        return view;
    }
